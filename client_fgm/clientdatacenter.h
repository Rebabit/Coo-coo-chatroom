#ifndef CLIENTDATACENTER_H
#define CLIENTDATACENTER_H
...
class ClientDataCenter : public QObject
{
    Q_OBJECT
public:
    static ClientDataCenter& Singleton(QObject * parent = 0){
...
private:
    ...
    QMap<QString, OnlineUserModel *> users;                         //已注册用户列表
    QList<QObject *> registeredObjects;                             //用户 ，对话 ，群聊
