...
public:
    ...
    Message(QString messagename,QString url,QWidget *parent = nullptr);
    ...
    //设置基本属性
    void setTextContent(QString txt, QString t, QSize allSize, UserType type, QString url = "Nop");
    //计算聊天气泡的size
