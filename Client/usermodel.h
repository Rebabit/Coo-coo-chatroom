...
class OfflineUserModel : virtual public UserModel, virtual public QObject
{
    Q_OBJECT
public:
    OfflineUserModel(QString Username, QObject *parent = nullptr);
...
public:
    ...
    OnlineUserModel(QString usrname, QString nick, QJsonObject json, QObject * parent = nullptr);
    ...
    const QString getTouxiang() const {return profile["touxiangURL"].toString(); }
    QJsonObject generateUserModelJson() const;
signals:
